...
import halfHalf from "../assets/images/halfhalf-logo.png";
import halfHalfMini from "../assets/images/halfhalf-logo-mini.png";
...
export const getIcon: (province: String) => React.ReactElement = (province) => {
    ...
    <Box>
      <Flex w="100%" h="60px" flexDir="row" py="10px" px={["4%", "10%"]} flex={1}>
        ...
        <Button
          ...
          onClick={onOpen}
        >
          <Image src={filter} w="19px" h="19px" />
        </Button>
      </Flex>
      <Flex
        background="#27397c"
