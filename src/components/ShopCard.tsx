...
import parking from "../assets/images/ที่จอดรถ.png";
import booking from "../assets/images/รับจองล่วงหน้า.png";
import pet from "../assets/images/สามารถนำสัตว์เลี้ยงเข้าได้.png";
  ...
  return (
    <Tooltip label={name} fontSize="md">
      <Flex
        ...
        alignItems="center"
      >
        {name === "ที่จอดรถ" && <Image src={parking} w="18px" h="18px" />}
        {name === "รับจองล่วงหน้า" && <Image src={booking} w="18px" h="18px" />}
        {name === "สามารถนำสัตว์เลี้ยงเข้าได้" && <Image src={pet} w="18px" h="18px" />}
      </Flex>
    </Tooltip>
  );
};
